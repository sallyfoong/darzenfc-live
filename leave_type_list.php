...
$actionUrl = 'leave_type';

$sub_title = "Leave Type";
$action_dis = "Leave Type Record";
$datainfo = "SELECT `id`, `leave_name`, `leave_date`, `year`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM leave_type  WHERE status ='A' ORDER BY id DESC";
