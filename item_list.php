...
$sub_title = "Item";
$action_dis = "Item Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM item  WHERE status ='A' ORDER BY id DESC";
