...
$actionUrl = 'marital_status';

$sub_title = "Marital Status";
$action_dis = "Marital Status Record";
$datainfo = "SELECT `id`, `name`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM marital_status  WHERE status ='A' ORDER BY id DESC";
