...
if (isset($_REQUEST['productName']) && isset($_REQUEST['pageno']) && isset($_REQUEST['warehouseID'])) {
    //it's very important!
    ...
    echo '<div class="container">';
        ...
        <= $_REQUEST['pageno']; $x++) { // user data
            $urlRtn = "https://darzenfc.xyz/cms/live/stockRecord.php?barcode=".($barcode_next_number + $x)."&pid=".$prdId."&wid=".$_REQUEST['warehouseID'];
