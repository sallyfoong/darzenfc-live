...
// of course, we need rights to create the temp dir
...
if (isset($_REQUEST['productName']) && isset($_REQUEST['pageno'])) {
    ...
    for ($x = 1; $x <= $_REQUEST['pageno']; $x++) { // user data
        ...
        echo '<div class="column"><img src="' . $PNG_WEB_DIR . basename($filename) . '" />' . '<p>' . $_REQUEST['productName'] . ' ' . $x . '</p></div>';
    }
