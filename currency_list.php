...
$sub_title = "Currency";
$action_dis = "Currency Record";
$datainfo = "SELECT `id`, `name`, `convert_rate_myr`, `convert_rate_sgd`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM currency  WHERE status ='A' ORDER BY id DESC";
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Action</th>
                                                <th>Name</th>
                                                <th>MYR Convert Rate</th>
                                                <th>SGD Convert Rate</th>
                                                <th>Create date</th>
                                                <th>Create by</th>
                                                <th>Update date</th>
                                                <th>Update by</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['convert_rate_myr']; ?></td>
                                                <td><?php echo $row['convert_rate_sgd']; ?></td>
