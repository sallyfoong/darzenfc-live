...
$actionUrl = 'product_category';

$sub_title = "Product Category";
$action_dis = "Product Category Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM product_category  WHERE status ='A' ORDER BY id DESC";
