...
$actionUrl = 'product_status';

$sub_title = "Product Status";
$action_dis = "Product Status Record";
$datainfo = "SELECT `id`, `name`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM product_status  WHERE status ='A' ORDER BY id DESC";
