...
$sub_title = "User";
$action_dis = "User Record";
$datainfo = "SELECT `id`, `name`, `username`, `email`, access_id, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM user  WHERE status ='A' ORDER BY id DESC";
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo getUserRoleName($row['access_id']); ?></td>
