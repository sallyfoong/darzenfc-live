...
$actionUrl = 'unit_of_measurement';

$sub_title = "Unit of Measurement";
$action_dis = "Unit of Measurement Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM unit_of_measurement  WHERE status ='A' ORDER BY id DESC";
