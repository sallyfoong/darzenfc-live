...
$sub_title = "BANK";
$action_dis = "Bank Record";
$datainfo = "SELECT `id`, `name`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM bank  WHERE status ='A' ORDER BY id DESC";
