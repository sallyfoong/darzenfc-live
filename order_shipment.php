...
$page_action = 'Add';
$page_title = 'Order Shipment';
$sub_db = ORDERSHIPMENT; 
$back_url = SITEURL."/order_shipment_list.php";
$error_message = '';
$mode = input('mode');
$txtgetID = input('id');
                                ...
                                <form id="epfform" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-lg-4">
                                            <label for="hue-demo">Platform</label>
                                            ...
                                            <input type="text" name="org_platform" value="<?php echo $platform ; ?>"
                                                class="dnone">
                                        </div>
                                        <div class="form-group col-lg-4">
                                            <label for="hue-demo">Order Id</label>
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label for="hue-demo">Package</label>
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label for="hue-demo">Name / Username</label>
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label for="main_item_cost">Contact</label>
                                        ...
                                        <div class="form-group col-lg-4">
                                            <label for="main_item_cost">Postcode</label>
                                            <input type="text" name="main_item_cost" id="main_item_cost"
                                                class="form-control demo" data-control="hue"
                                                value="<?php echo $main_item_cost; ?>" />
                                            <input type="text" name="org_main_item_cost"
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="hue-demo">Address</label>
                                        ...
                                        <div class="form-group col-lg-6">
                                            <label for="hue-demo">Address 2</label>
