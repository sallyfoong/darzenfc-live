...
$actionUrl = 'employment_type';

$sub_title = "Employment Type Status";
$action_dis = "Employment Type Status Record";
$datainfo = "SELECT `id`, `name`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM employment_type  WHERE status ='A' ORDER BY id DESC";
