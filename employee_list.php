...
$sub_title = "Employee";
$action_dis = "Employee Record";
$datainfo = "SELECT `id`, `name`, `email`, `phone_no`, `alt_phone_no`, `gender`, `ic`, `birthday`, `join_date`, `annual_leave`, `mc_leave`, `hospital_leave`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM employee  WHERE status ='A' ORDER BY id DESC";
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['mc_leave']; ?></td>
                                                <td><?php echo $row['hospital_leave']; ?></td>
                                                <td><?php echo $row['create_date']." ".$row['create_time']; ?></td>
                                                <td><?php echo getUserRoleName($row['create_by']); ?></td>
                                                <td><?php echo $row['update_date']." ".$row['update_time']; ?></td>
                                                <td><?php echo getUserRoleName($row['update_by']); ?></td>
                                            </tr>
                                            <?php  } ?>
                                        </tbody>
                                        <tfoot>
