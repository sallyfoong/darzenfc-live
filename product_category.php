...
$sub_db = 'product_category'; 
$back_url = SITEURL."/product_category_list.php";
$error_message = '';
$mode = input('mode');
$txtgetID = input('id');
...
jQuery(document).ready(function() {
    jQuery("form").submit(function() {
        if (jQuery('#txtname').val() == "") {
            alert("Please fill the Product Category Name");
            return false;
        }
                            ...
                            <div class="card-body">
                                ...
                                <form id="epfform" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="hue-demo">Product Category Name</label>
