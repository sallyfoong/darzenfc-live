...
$sub_title = "WAREHOUSE";
$action_dis = "Warehouse Record";
$datainfo = "SELECT `id`, `name`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM warehouse  WHERE status ='A' ORDER BY id DESC";
