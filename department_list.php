...
$actionUrl = 'department';

$sub_title = "Department";
$action_dis = "Ddepartment Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM department  WHERE status ='A' ORDER BY id DESC";
