...
$sub_title = "PIN";
$action_dis = "Pin Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM pin  WHERE status ='A' ORDER BY id DESC";
