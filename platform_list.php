...
$sub_title = "Platform";
$action_dis = "Platform Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM platform  WHERE status ='A' ORDER BY id DESC";
