...
$sub_title = "Brand";
$action_dis = "Brand Record";
$datainfo = "SELECT `id`, `name`, `remark`, `create_date`, `create_time`, `create_by`, `update_date`, `update_time`, `update_by`, `status` FROM brand  WHERE status ='A' ORDER BY id DESC";
